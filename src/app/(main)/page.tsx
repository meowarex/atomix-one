                    ...
                    <Column fillWidth gap="12">
                      <Row>
                        <Text
                          ...
                          style={{ fontFamily: "var(--font-berkeley-mono)" }}
                        >
                          A Windows Toolkit For Windows 10/11
                        </Text>
                      </Row>
                      <Column gap="0">
                        <Text onBackground="neutral-weak" variant="code-default-m">
                          {"// Change settings, Hidden from the settings app"}
                        </Text>
                        <Text onBackground="neutral-weak" variant="code-default-m">
                          {"// Manage startup programs, The proper way"}
                        </Text>
                        <Text onBackground="neutral-weak" variant="code-default-m">
                  ...
                  <Flex zIndex={1} padding="20" direction="column">
                    ...
                    <Column fillWidth gap="12">
                      ...
                      <Column gap="0">
                        ...
                        <Text onBackground="neutral-weak" variant="code-default-m">
                          {"// Highly customizable Sexy user interface"}
                        </Text>
                        <Text onBackground="neutral-weak" variant="code-default-m">
                          {"// Lossless Quality audio playback (24-bit/192kHz)"}
                        </Text>
                      </Column>
                    </Column>
                  </Flex>
                ...
                >
                  ...
                  <Flex zIndex={1} padding="20" direction="column">
                    ...
                    <Column fillWidth gap="16">
                      ...
                      <Column gap="0">
                        <Text onBackground="neutral-weak" variant="code-default-m">
                          {"// Sexy Lyrics Transformation"}
                        </Text>
                        <Text onBackground="neutral-weak" variant="code-default-m">
                          {"// Sexy UI Transformation"}
                        </Text>
                        <Text onBackground="neutral-weak" variant="code-default-m">
                          {"// Sexy Everything!!!"}
                        </Text>
